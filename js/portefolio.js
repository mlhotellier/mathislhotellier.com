document.addEventListener('DOMContentLoaded', () => {
    ...
    function displayProjects(projects) {
      ...
      projects.forEach(project => {
        ...
        <img loading="lazy" class="card-img" src="${project.imageHead}" alt="${project.title}"  onerror="this.onerror=null;this.src='./img/no-img.png';">
    ...
    viewAllProjectsBtn.addEventListener('click', () => {
      ...
      if (lessBtn === 'Less projects') {
        displayProjects(fourRandomProjects);
        viewAllProjectsBtn.innerText = 'More projects...';
      } else {
        displayProjects(projectsDatas);
        viewAllProjectsBtn.innerText = 'Less projects';
      }
    });
